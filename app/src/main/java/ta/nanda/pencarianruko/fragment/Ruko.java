...
public class Ruko extends Fragment{

    private RecyclerView rc;
    private List<ItemRuko> itemList;
    private RukoAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.ruko, container, false);
        ...
        adapter = new RukoAdapter(getActivity(), itemList);
